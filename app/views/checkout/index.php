                            ...
                            <div class="flex items-start gap-3">
                                <div class="w-12 h-12 flex-shrink-0 bg-gray-100 rounded overflow-hidden">
                                    <?php if (!empty($item['image'])): ?>
                                        <img src="<?php echo SITE_URL . $item['image']; ?>" class="w-full h-full object-cover">
                                    <?php else: ?>
                                ...
                                <div>
                                    ...
                                    <?php if (!empty($item['variant_attributes'])): ?>
                                        <p class="text-xs text-gray-500"><?php echo htmlspecialchars($item['variant_attributes']); ?></p>
                                    <?php endif; ?>
                                    <p class="text-xs text-gray-500">Qty: <?php echo $item['quantity']; ?></p>
                                </div>
                            </div>
                            <span class="font-medium text-gray-900 self-start">₹<?php echo number_format($item['price'] * $item['quantity'], 2); ?></span>
                        </div>
                        <?php endforeach; ?>
                    </div>
