...
<body class="bg-gray-50">
    ...
    $isProductList = $checkPath('admin/products') && !$checkPath('admin/product/add') && !$checkPath('admin/product/edit');
    ...
    <div>
        <!-- Left Sidebar -->
        <aside class="admin-sidebar" id="adminSidebar" data-active-submenu="<?php echo $activeSubmenu; ?>" data-active-nested-submenu="<?php echo $activeNestedSubmenu; ?>">
            <!-- Sidebar Header -->
            ...
            <nav class="py-4 overflow-y-auto" style="max-height: calc(100vh - 80px);">
                <!-- 1. Dashboard -->
                <div>
                    <div class="sidebar-menu-item <?php echo ($isDashboard || $isDashboardOverview || $isDashboardInsights || $isDashboardAnalytics) ? 'active' : ''; ?>" data-submenu-toggle="dashboard" style="cursor: pointer;">
                    ...
                    <div class="sidebar-submenu <?php echo ($isDashboard || $isDashboardOverview || $isDashboardInsights || $isDashboardAnalytics) ? 'open' : ''; ?>" data-submenu="dashboard">
                        <a href="<?php echo SITE_URL; ?>/admin" class="sidebar-submenu-item <?php echo $isDashboardOverview ? 'active' : ''; ?>">
                            Overview
                        </a>
                        <a href="<?php echo SITE_URL; ?>/admin/quick-insights" class="sidebar-submenu-item <?php echo $isDashboardInsights ? 'active' : ''; ?>">
                            Insights
                        </a>
                        <a href="<?php echo SITE_URL; ?>/admin/analytics" class="sidebar-submenu-item <?php echo $isDashboardAnalytics ? 'active' : ''; ?>">
                ...
                <!-- 2. Catalog -->
                <div>
                    <div class="sidebar-menu-item <?php echo $isCatalog ? 'active' : ''; ?>" data-submenu-toggle="catalog" style="cursor: pointer;">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="sidebar-submenu <?php echo $isCatalog ? 'open' : ''; ?>" data-submenu="catalog">
                        ...
                        <div>
                            <div class="sidebar-submenu-item <?php echo $isProducts ? 'active' : ''; ?>" data-nested-submenu-toggle="products" style="cursor: pointer; display: flex; align-items: center; justify-content: space-between;">
                                <span>Products</span>
                                <svg class="w-4 h-4 transition-transform nested-submenu-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                                </svg>
                            </div>
                            <div class="sidebar-nested-submenu <?php echo $isProducts ? 'open' : ''; ?>" data-nested-submenu="products">
                                <a href="<?php echo SITE_URL; ?>/admin/products" class="sidebar-nested-submenu-item <?php echo $isProductList ? 'active' : ''; ?>">
                                    All Products
                                </a>
                                <a href="<?php echo SITE_URL; ?>/admin/product/add" class="sidebar-nested-submenu-item <?php echo $isProductAdd ? 'active' : ''; ?>">
                                    Add Product
                                </a>
                                <a href="<?php echo SITE_URL; ?>/admin/products/inventory" class="sidebar-nested-submenu-item <?php echo $isProductInventory ? 'active' : ''; ?>">
                                    Inventory
                                </a>
                                <a href="<?php echo SITE_URL; ?>/admin/products/reviews" class="sidebar-nested-submenu-item <?php echo $isProductReviews ? 'active' : ''; ?>">
                                    Product Reviews
                                </a>
                            </div>
                        </div>
                        <a href="<?php echo SITE_URL; ?>/admin/categories" class="sidebar-submenu-item <?php echo $isCategories ? 'active' : ''; ?>">
                            Categories
                        </a>
                        <a href="<?php echo SITE_URL; ?>/admin/attributes" class="sidebar-submenu-item <?php echo $isAttributes ? 'active' : ''; ?>">
                            Attributes
                        </a>
                    </div>
                </div>
                ...
                <!-- 3. Orders -->
                <div>
                    <div class="sidebar-menu-item <?php echo $isOrders ? 'active' : ''; ?>" data-submenu-toggle="orders" style="cursor: pointer;">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="sidebar-submenu <?php echo $isOrders ? 'open' : ''; ?>" data-submenu="orders">
                        <a href="<?php echo SITE_URL; ?>/admin/orders" class="sidebar-submenu-item <?php echo $isOrdersAll ? 'active' : ''; ?>">
                            All Orders
                        </a>
                        <a href="<?php echo SITE_URL; ?>/admin/orders?order_status=<?php echo ORDER_STATUS_PENDING; ?>" class="sidebar-submenu-item <?php echo $isOrdersPending ? 'active' : ''; ?>">
                            Pending Orders
                        </a>
                        <a href="<?php echo SITE_URL; ?>/admin/orders?order_status=<?php echo ORDER_STATUS_PROCESSING; ?>" class="sidebar-submenu-item <?php echo $isOrdersProcessing ? 'active' : ''; ?>">
                            Processing Orders
                        </a>
                        <a href="<?php echo SITE_URL; ?>/admin/orders?order_status=<?php echo ORDER_STATUS_SHIPPED; ?>" class="sidebar-submenu-item <?php echo $isOrdersShipped ? 'active' : ''; ?>">
                            Shipped Orders
                        </a>
                        <a href="<?php echo SITE_URL; ?>/admin/orders?order_status=<?php echo ORDER_STATUS_DELIVERED; ?>" class="sidebar-submenu-item <?php echo $isOrdersCompleted ? 'active' : ''; ?>">
                            Completed Orders
                        </a>
                        <a href="<?php echo SITE_URL; ?>/admin/orders?order_status=<?php echo ORDER_STATUS_RETURNED; ?>" class="sidebar-submenu-item <?php echo $isOrdersReturns ? 'active' : ''; ?>">
                            Returns / Refunds
                        </a>
                    </div>
                </div>
                ...
                <!-- 4. Customers -->
                <div>
                    <div class="sidebar-menu-item <?php echo $isCustomers ? 'active' : ''; ?>" data-submenu-toggle="customers" style="cursor: pointer;">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="sidebar-submenu <?php echo $isCustomers ? 'open' : ''; ?>" data-submenu="customers">
                        <a href="<?php echo SITE_URL; ?>/admin/customers" class="sidebar-submenu-item <?php echo $isCustomerList ? 'active' : ''; ?>">
                            Customer List
                        </a>
                        <a href="<?php echo SITE_URL; ?>/admin/customers/groups" class="sidebar-submenu-item <?php echo $isCustomerGroups ? 'active' : ''; ?>">
                            Customer Groups
                        </a>
                        <a href="<?php echo SITE_URL; ?>/admin/customers/reviews" class="sidebar-submenu-item <?php echo $isCustomerReviews ? 'active' : ''; ?>">
                            Reviews & Feedback
                        </a>
                    </div>
                </div>
                ...
                <!-- 5. Marketing -->
                <div>
                    <div class="sidebar-menu-item <?php echo $isMarketing ? 'active' : ''; ?>" data-submenu-toggle="marketing" style="cursor: pointer;">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="sidebar-submenu <?php echo $isMarketing ? 'open' : ''; ?>" data-submenu="marketing">
                        ...
                        <div>
                            <div class="sidebar-submenu-item <?php echo $isPromotions ? 'active' : ''; ?>" data-nested-submenu-toggle="promotions" style="cursor: pointer; display: flex; align-items: center; justify-content: space-between;">
                                <span>Promotions</span>
                                <svg class="w-4 h-4 transition-transform nested-submenu-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                                </svg>
                            </div>
                            <div class="sidebar-nested-submenu <?php echo $isPromotions ? 'open' : ''; ?>" data-nested-submenu="promotions">
                                <a href="<?php echo SITE_URL; ?>/admin/coupons" class="sidebar-nested-submenu-item <?php echo $isCoupons ? 'active' : ''; ?>">
                                    Coupons
                                </a>
                                <a href="<?php echo SITE_URL; ?>/admin/discounts" class="sidebar-nested-submenu-item <?php echo $isDiscounts ? 'active' : ''; ?>">
                                    Discounts
                                </a>
                            </div>
                        </div>
                        <a href="<?php echo SITE_URL; ?>/admin/hero-banners" class="sidebar-submenu-item <?php echo $isBanners ? 'active' : ''; ?>">
                            Banners / Sliders
                        </a>
                        <a href="<?php echo SITE_URL; ?>/admin/campaigns" class="sidebar-submenu-item <?php echo $isCampaignAnalytics ? 'active' : ''; ?>">
                            Campaign Analytics
                        </a>
                    </div>
                </div>
                ...
                <!-- 6. Reports -->
                <div>
                    <div class="sidebar-menu-item <?php echo $isReports ? 'active' : ''; ?>" data-submenu-toggle="reports" style="cursor: pointer;">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="sidebar-submenu <?php echo $isReports ? 'open' : ''; ?>" data-submenu="reports">
                        <a href="<?php echo SITE_URL; ?>/admin/reports?type=sales" class="sidebar-submenu-item <?php echo $isSalesReports ? 'active' : ''; ?>">
                            Sales Reports
                        </a>
                        <a href="<?php echo SITE_URL; ?>/admin/revenue-analytics" class="sidebar-submenu-item <?php echo $isRevenueReports ? 'active' : ''; ?>" data-reports-link>
                            Revenue Analytics (Detailed)
                        </a>
                        <a href="<?php echo SITE_URL; ?>/admin/reports?type=product" class="sidebar-submenu-item <?php echo $isProductReports ? 'active' : ''; ?>">
                            Product Performance
                        </a>
                        <a href="<?php echo SITE_URL; ?>/admin/reports?type=customer" class="sidebar-submenu-item <?php echo $isCustomerReports ? 'active' : ''; ?>">
                            Customer Reports
                        </a>
                    </div>
                </div>
                ...
                <!-- 7. Support -->
                <div>
                    <div class="sidebar-menu-item <?php echo $isSupport ? 'active' : ''; ?>" data-submenu-toggle="support" style="cursor: pointer;">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="sidebar-submenu <?php echo $isSupport ? 'open' : ''; ?>" data-submenu="support">
                        <a href="<?php echo SITE_URL; ?>/admin/support/tickets" class="sidebar-submenu-item <?php echo $isSupportTickets ? 'active' : ''; ?>">
                            Queries / Tickets
                        </a>
                        <a href="<?php echo SITE_URL; ?>/admin/support/chat" class="sidebar-submenu-item <?php echo $isSupportChat ? 'active' : ''; ?>">
                            Live Chat
                        </a>
                        <a href="<?php echo SITE_URL; ?>/admin/support/disputes" class="sidebar-submenu-item <?php echo $isSupportDisputes ? 'active' : ''; ?>">
                            Dispute Management
                        </a>
                    </div>
                </div>
                ...
                <!-- 8. Settings -->
                <div>
                    <div class="sidebar-menu-item <?php echo $isSettings ? 'active' : ''; ?>" data-submenu-toggle="settings" style="cursor: pointer;">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="sidebar-submenu <?php echo $isSettings ? 'open' : ''; ?>" data-submenu="settings">
                        ...
                        <div>
                            <div class="sidebar-submenu-item <?php echo $isSettingsStore ? 'active' : ''; ?>" data-nested-submenu-toggle="store-setup" style="cursor: pointer; display: flex; align-items: center; justify-content: space-between;">
                                <span>Store Setup</span>
                                <svg class="w-4 h-4 transition-transform nested-submenu-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                                </svg>
                            </div>
                            <div class="sidebar-nested-submenu <?php echo $isSettingsStore ? 'open' : ''; ?>" data-nested-submenu="store-setup">
                                <a href="<?php echo SITE_URL; ?>/admin/settings?section=general" class="sidebar-nested-submenu-item <?php echo ($isSettings && $settingsSection === 'general') ? 'active' : ''; ?>">
                                    General Settings
                                </a>
                                <a href="<?php echo SITE_URL; ?>/admin/settings?section=store" class="sidebar-nested-submenu-item <?php echo ($isSettings && $settingsSection === 'store') ? 'active' : ''; ?>">
                                    Store Settings
                                </a>
                                <a href="<?php echo SITE_URL; ?>/admin/settings?section=seo" class="sidebar-nested-submenu-item <?php echo ($isSettings && $settingsSection === 'seo') ? 'active' : ''; ?>">
                                    SEO & Analytics
                                </a>
                                <a href="<?php echo SITE_URL; ?>/admin/settings?section=maintenance" class="sidebar-nested-submenu-item <?php echo $isSettingsMaintenance ? 'active' : ''; ?>">
                                    Maintenance Mode
                                </a>
                            </div>
                        </div>
                        ...
                        <div>
                            <div class="sidebar-submenu-item <?php echo $isSettingsPayment ? 'active' : ''; ?>" data-nested-submenu-toggle="payments" style="cursor: pointer; display: flex; align-items: center; justify-content: space-between;">
                                <span>Payments</span>
                                <svg class="w-4 h-4 transition-transform nested-submenu-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                                </svg>
                            </div>
                            <div class="sidebar-nested-submenu <?php echo $isSettingsPayment ? 'open' : ''; ?>" data-nested-submenu="payments">
                                <a href="<?php echo SITE_URL; ?>/admin/settings?section=payment" class="sidebar-nested-submenu-item <?php echo ($isSettings && $settingsSection === 'payment') ? 'active' : ''; ?>">
                                    Payment Methods
                                </a>
                                <a href="<?php echo SITE_URL; ?>/admin/settings?section=tax" class="sidebar-nested-submenu-item <?php echo ($isSettings && $settingsSection === 'tax') ? 'active' : ''; ?>">
                                    Tax Configuration
                                </a>
                            </div>
                        </div>
                        ...
                        <div>
                            <div class="sidebar-submenu-item <?php echo $isSettingsShipping ? 'active' : ''; ?>" data-nested-submenu-toggle="shipping" style="cursor: pointer; display: flex; align-items: center; justify-content: space-between;">
                                <span>Shipping</span>
                                <svg class="w-4 h-4 transition-transform nested-submenu-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                                </svg>
                            </div>
                            <div class="sidebar-nested-submenu <?php echo $isSettingsShipping ? 'open' : ''; ?>" data-nested-submenu="shipping">
                                <a href="<?php echo SITE_URL; ?>/admin/settings?section=shipping&subsection=zones" class="sidebar-nested-submenu-item <?php echo $isSettingsShippingZones ? 'active' : ''; ?>">
                                    Shipping Zones
                                </a>
                                <a href="<?php echo SITE_URL; ?>/admin/settings?section=shipping&subsection=delivery" class="sidebar-nested-submenu-item <?php echo $isSettingsDeliveryMethods ? 'active' : ''; ?>">
                                    Delivery Methods
                                </a>
                            </div>
                        </div>
                        <a href="<?php echo SITE_URL; ?>/admin/settings?section=notification" class="sidebar-submenu-item <?php echo $isSettingsNotifications ? 'active' : ''; ?>">
                            Notifications
                        </a>
                        <!-- Security (Nested Submenu) -->
                        <div>
                            <div class="sidebar-submenu-item <?php echo $isSettingsSecurity ? 'active' : ''; ?>" data-nested-submenu-toggle="security" style="cursor: pointer; display: flex; align-items: center; justify-content: space-between;">
                                <span>Security</span>
                                <svg class="w-4 h-4 transition-transform nested-submenu-arrow" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                                </svg>
                            </div>
                            <div class="sidebar-nested-submenu <?php echo $isSettingsSecurity ? 'open' : ''; ?>" data-nested-submenu="security">
                                <a href="<?php echo SITE_URL; ?>/admin/settings?section=security&subsection=roles" class="sidebar-nested-submenu-item <?php echo $isSettingsRolesPermissions ? 'active' : ''; ?>">
                                    Roles & Permissions
                                </a>
                                <a href="<?php echo SITE_URL; ?>/admin/settings?section=security&subsection=settings" class="sidebar-nested-submenu-item <?php echo $isSettingsSecuritySettings ? 'active' : ''; ?>">
                                    Security Settings
                                </a>
                            </div>
                        </div>
                        <a href="<?php echo SITE_URL; ?>/admin/settings?section=integration" class="sidebar-submenu-item <?php echo $isSettingsIntegrations ? 'active' : ''; ?>">
                            Integrations
                        </a>
                        <a href="<?php echo SITE_URL; ?>/admin/settings?section=backup" class="sidebar-submenu-item <?php echo $isSettingsBackup ? 'active' : ''; ?>">
                            Backup & Maintenance
                        </a>
                    </div>
                </div>
            ...
            <button data-mobile-menu-close
                    class="md:hidden absolute top-4 right-4 text-white p-2">
        ...
        <div class="admin-main-content flex-1">
            ...
            <header class="admin-top-header">
                <div class="flex items-center justify-between">
                    ...
                    <!-- Page Title -->
                    <h1 class="text-2xl font-bold text-gray-800"><?php echo isset($pageTitle) ? $pageTitle : 'Dashboard'; ?></h1>
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <!-- Admin Profile -->
                        <div class="relative">
                            <button data-profile-toggle class="flex items-center gap-2 text-gray-700 hover:text-gray-900">
                                ...
                                <span class="hidden md:block font-medium"><?php echo htmlspecialchars(Session::get('user_name') ?? 'Admin User'); ?></span>
                            ...
                            <div data-profile-dropdown
                                 class="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg py-1 z-50 border border-gray-200" style="display: none;">
