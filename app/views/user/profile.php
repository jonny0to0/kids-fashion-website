    ...
    <div class="max-w-4xl mx-auto">
        ...
        <?php if (Session::isAdmin()): ?>
            ...
            <div class="bg-pink-50 border border-pink-200 rounded-lg p-4 mb-6">
                <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
                    <div>
                        <h3 class="font-semibold text-pink-900 text-sm sm:text-base">Admin Access</h3>
                        <p class="text-xs sm:text-sm text-pink-700">You have administrative privileges</p>
                    </div>
                    <a href="<?php echo SITE_URL; ?>/admin"
                        class="bg-pink-600 text-white px-4 sm:px-6 py-2 rounded-lg hover:bg-pink-700 font-medium text-sm sm:text-base whitespace-nowrap">
        ...
        <?php if (!Session::isAdmin()): ?>
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                ...
                <a href="<?php echo SITE_URL; ?>/user/wishlist"
                    class="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition">
                    <div class="flex items-center">
                        <div class="bg-pink-100 p-3 rounded-full mr-4">
                            <svg class="w-6 h-6 text-pink-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="<?php echo SITE_URL; ?>/user/profile"
                    class="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition border-2 border-pink-500">
                    <div class="flex items-center">
                        <div class="bg-pink-100 p-3 rounded-full mr-4">
                            <svg class="w-6 h-6 text-pink-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <form method="POST" action="<?php echo SITE_URL; ?>/user/profile">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                    ...
                    <div>
                        ...
                        <input type="text"
                            value="<?php echo ucfirst(htmlspecialchars($user['user_type'] ?? 'customer')); ?>" disabled
                            class="w-full border border-gray-300 rounded px-4 py-2 bg-gray-100">
                    </div>
                </div>
                ...
                <div class="mt-4 sm:mt-6">
                    <button type="submit"
                        class="w-full sm:w-auto bg-pink-600 text-white px-6 py-3 rounded-lg hover:bg-pink-700 font-bold text-sm sm:text-base">
                        Update Profile
                    </button>
                </div>
            </form>
