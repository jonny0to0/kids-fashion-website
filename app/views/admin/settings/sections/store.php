...
<div class="space-y-6">
    ...
    <div class="bg-blue-50 border border-blue-200 rounded-lg p-4">
        <div class="flex items-start">
            ...
            <div class="flex-1">
                <h3 class="text-sm font-semibold text-blue-800 mb-1">Maintenance Mode Management</h3>
                <p class="text-xs text-blue-700 mb-3">To enable or disable maintenance mode, configure maintenance messages, or set maintenance schedules, please use the dedicated Maintenance Mode settings page.</p>
