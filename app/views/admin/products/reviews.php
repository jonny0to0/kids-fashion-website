    ...
    <form method="GET" action="<?php echo SITE_URL; ?>/admin/products/reviews" class="flex flex-wrap gap-4 items-end">
        ...
        <div class="min-w-[150px]">
            ...
            <select name="status" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-pink-500 focus:border-transparent">
                <option value="all" <?php echo ($statusFilter ?? 'all') === 'all' ? 'selected' : ''; ?>>All Reviews</option>
        ...
        <?php if (!empty($search) || ($statusFilter ?? 'all') !== 'all'): ?>
            <a href="<?php echo SITE_URL; ?>/admin/products/reviews" class="px-6 py-2 border border-gray-300 rounded-lg font-medium text-gray-700 hover:bg-gray-50">
                Clear
            </a>
        <?php endif; ?>
    </form>
                        ...
                        <tr class="border-b border-gray-100 hover:bg-gray-50">
                            <td class="py-3 px-4">
                                <div class="flex items-center gap-3">
                                    ...
                                    <?php endif; ?>
                                    <div>
                                        <div class="font-medium text-gray-800"><?php echo htmlspecialchars($review['product_name']); ?></div>
