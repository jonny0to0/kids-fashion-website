...
<div class="admin-card mb-6">
    ...
    <div class="flex flex-wrap gap-3">
        <a href="<?php echo SITE_URL; ?>/admin/product/add" class="btn-pink-gradient px-6 py-2.5 rounded-lg font-medium inline-flex items-center gap-2 transition-all duration-200">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"></path>
            </svg>
            Add Product
        </a>
        <a href="<?php echo SITE_URL; ?>/admin/categories/add" class="bg-white border border-gray-300 text-gray-700 px-6 py-2.5 rounded-lg font-medium hover:bg-gray-50 inline-flex items-center gap-2 transition-all duration-200">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"></path>
            </svg>
            Add Category
        </a>
        <a href="<?php echo SITE_URL; ?>/admin/orders" class="bg-white border border-gray-300 text-gray-700 px-6 py-2.5 rounded-lg font-medium hover:bg-gray-50 inline-flex items-center gap-2 transition-all duration-200">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"></path>
            </svg>
            Manage Orders
        </a>
        <a href="<?php echo SITE_URL; ?>/admin/hero-banners" class="btn-pink-gradient px-6 py-2.5 rounded-lg font-medium inline-flex items-center gap-2 transition-all duration-200">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
    ...
    <div class="admin-card">
            ...
            <div class="grid grid-cols-3 gap-2 mb-4">
                ...
                ?>
                    <div class="relative">
                        ...
                        <?php endif; ?>
                        <span class="absolute bottom-1 right-1 px-1.5 py-0.5 rounded text-xs font-medium <?php echo $isActive ? 'badge-active' : 'badge-inactive'; ?>">
        ...
        <a href="<?php echo SITE_URL; ?>/admin/hero-banners" class="btn-pink-gradient px-6 py-2.5 rounded-lg font-medium inline-flex items-center gap-2 w-full justify-center transition-all duration-200">
            Manage Banners
        </a>
    </div>
</div>
...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
    ...
    <div class="lg:col-span-2 admin-card">
        <div class="flex items-center justify-between mb-4">
            ...
            <a href="<?php echo SITE_URL; ?>/admin/orders" class="text-sm text-pink-600 hover:text-pink-700 font-medium">
                View All →
            </a>
        </div>
                            ...
                            <?php foreach ($recentOrders as $order): ?>
                                <tr class="border-b border-gray-100 hover:bg-gray-50">
                                    <td class="py-3 px-2 text-sm text-gray-800">
                                        <a href="<?php echo SITE_URL; ?>/admin/orders/<?php echo $order['order_id']; ?>" class="text-pink-600 hover:text-pink-700 font-medium">
                                    ...
                                    <td class="py-3 px-2 text-sm font-semibold text-gray-800">$<?php echo number_format($order['final_amount'], 2); ?></td>
                                    <td class="py-3 px-2">
                                        <?php 
